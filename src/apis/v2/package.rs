...
pub async fn read(
    ...
    name: &str,
    namespace: &str,
) -> Result<package::Package, Error<ReadError>> {
...
pub async fn read_version(
    ...
    namespace: &str,
    version: &str,
) -> Result<package::Version, Error<VersionReadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VersionReadError> =
...
pub async fn list(
    configuration: &Configuration,
    cursor: Option<&str>,
) -> Result<package::ListResponse, Error<ListError>> {
    let local_var_configuration = configuration;
