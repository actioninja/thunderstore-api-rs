...
use crate::models::v2::front_page_content::FrontPageContent;
use crate::models::v2::render_markdown::{RenderMarkdownParams, RenderMarkdownResponse};
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CurrentCommunityError {
    UnknownValue(serde_json::Value),
}
...
pub async fn current_user(configuration: &Configuration) -> Result<(), Error<CurrentUserError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CurrentUserError> =
...
pub async fn upload_list(configuration: &Configuration) -> Result<(), Error<UploadListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn current_community(
    configuration: &Configuration,
) -> Result<Community, Error<CurrentCommunityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CurrentCommunityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn frontpage(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FrontpageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn render_markdown(
    configuration: &Configuration,
    data: RenderMarkdownParams,
) -> Result<RenderMarkdownResponse, Error<RenderMarkdownError>> {
    let local_var_configuration = configuration;
